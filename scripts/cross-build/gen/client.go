...
type GithubGraphQLClient interface {
	GetTags(ctx context.Context, owner string, name string, first *int, interceptors ...clientv2.RequestInterceptor) (*GetTags, error)
}
...
type Mutation struct {
	...
	AddProjectDraftIssue                                        *AddProjectDraftIssuePayload                                        "json:\"addProjectDraftIssue,omitempty\" graphql:\"addProjectDraftIssue\""
	...
	UpdateProjectDraftIssue                                     *UpdateProjectDraftIssuePayload                                     "json:\"updateProjectDraftIssue,omitempty\" graphql:\"updateProjectDraftIssue\""
...
type GetTags_Repository_Refs_Nodes struct {
	Name string "json:\"name\" graphql:\"name\""
}
type GetTags_Repository_Refs struct {
	Nodes []*GetTags_Repository_Refs_Nodes "json:\"nodes\" graphql:\"nodes\""
}
type GetTags_Repository struct {
	Refs *GetTags_Repository_Refs "json:\"refs\" graphql:\"refs\""
}
type GetTags struct {
	Repository *GetTags_Repository "json:\"repository\" graphql:\"repository\""
}
