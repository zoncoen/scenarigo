...
var file_test_test_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x6f, 0x64, 0x79, 0x22, 0x80, 0x02, 0x0a, 0x0c,
...
var file_test_test_proto_depIdxs = []int32{
	...
	3, // 1: scenarigo.testdata.test.EchoResponse.nullable_string:type_name -> scenarigo.testdata.test.StringValue
	1, // 2: scenarigo.testdata.test.Test.Echo:input_type -> scenarigo.testdata.test.EchoRequest
	2, // 3: scenarigo.testdata.test.Test.Echo:output_type -> scenarigo.testdata.test.EchoResponse
